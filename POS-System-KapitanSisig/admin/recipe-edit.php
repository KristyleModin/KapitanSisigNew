...
if (isset($_GET['id'])) {
    ...
    if ($recipe) {
        ...
        $ingredientQuery = "
            SELECT ri.id AS recipe_ingredient_id, ri.ingredient_id, ri.unit_id, ri.quantity, i.name AS ingredient_name, u.name AS unit_name
                                ...
                                <tr>
                                    <td>
                                        <select name="ingredient_id[]" class="form-select" required>
                                            ...
                                            <?php endwhile; ?>
                                            <?php mysqli_data_seek($ingredients, 0); // Reset ingredient pointer ?>
                                        </select>
                                    </td>
                                    <td>
                                        <select name="unit_id[]" class="form-select" required>
                                            ...
                                            <?php endwhile; ?>
                                            <?php mysqli_data_seek($units, 0); // Reset unit pointer ?>
                                        </select>
                                    </td>
                                    <td>
...
<div id="unitOptions" style="display: none;">
    <select name="unit_id[]" class="form-select" required>
        <option value="">Select Unit</option>
        <?php
        $unitResult = mysqli_query($conn, "SELECT * FROM units");
